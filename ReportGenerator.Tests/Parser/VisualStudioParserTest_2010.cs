namespace ReportGenerator.Tests.Parser
{
    ...
    {
        private static readonly string FilePath = CommonNames.ReportDirectory + "VisualStudio2010.coveragexml";
        ...
        {
            var metrics = assemblies.Single(a => a.Name == CommonNames.TestNamespace + "exe").Classes.Single(c => c.Name == CommonNames.TestNamespace + "TestClass").MethodMetrics;
        ...
        {
            return assemblies
                .Single(a => a.Name == CommonNames.TestNamespace + "exe").Classes
